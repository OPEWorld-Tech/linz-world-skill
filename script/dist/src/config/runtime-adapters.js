...
exports.DEFAULT_EVENT_PROMPT = [
    ...
    "如果这是 `wsp.oso.consultation.report.generated`，且 payload.recipient_os_id 等于当前元神 os_id，表示治理风险预估已到达乙方收件箱；当前临时流程不再等待甲乙双方同意，乙方必须立即基于已拆解 TaskBubble 执行任务，写出真实交付文件，执行 `linz upload <文件路径>`，然后发布 `mrk.order.handover.submitted`。",
